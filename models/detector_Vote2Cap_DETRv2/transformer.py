...
from models.detector_Vote2Cap_DETRv2.msdeformattn import MSDeformAttn
...
class MaskedTransformerEncoder(TransformerEncoder):
    ...
    def forward(self, src,
        ...
        for idx, layer in enumerate(self.layers):
            ...
            output = layer(output, all_coords=xyz, scale_ranges=scale_ranges, reference_points=xyz, pos=pos)
            output = output.permute(1, 0, 2)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self, src,
        ...
        input_flatten = src
        src2 = self.self_attn(q, all_coords, scale_ranges, reference_points, input_flatten=input_flatten)
    ...
    def forward(self, src,
        ...
        if self.normalize_before:
            return self.forward_pre(src, all_coords, scale_ranges, reference_points, pos)
        return self.forward_post(src, all_coords, scale_ranges, reference_points, pos)
